...
let buscarLibro = prompt("Ingresar titulo de libro:");
let libroEncontrado = programmingBooks.includes(buscarLibro);
alert (libroEncontrado ? `${buscarLibro} si existe` : `${buscarLibro} no existe`);
